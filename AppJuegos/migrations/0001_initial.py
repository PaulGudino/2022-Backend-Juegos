# Generated by Django 4.1.1 on 2022-10-22 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('L', 'Legendaria'), ('E', 'Epica'), ('R', 'Rara'), ('C', 'Comun')], default='C', max_length=1, verbose_name='Categoria')),
                ('juego', models.CharField(choices=[('T', 'Traga Monedas')], default='T', max_length=1, verbose_name='Juego')),
                ('user_modify', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_modify', to=settings.AUTH_USER_MODEL, verbose_name='Usuario que modifica')),
                ('user_register', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_register', to=settings.AUTH_USER_MODEL, verbose_name='Usuario que registra')),
            ],
            options={
                'verbose_name': 'Premio',
