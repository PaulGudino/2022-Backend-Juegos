# Generated by Django 4.1.1 on 2022-11-01 23:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.CharField(choices=[('T', 'Traga Monedas')], default='T', max_length=1, verbose_name='Juego')),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
                'verbose_name': 'Juego',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ('game_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppJuegos.game', verbose_name='Juego')),
                ('premio_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='award_in_game', to='AppJuegos.award', unique=True, verbose_name='Premio')),
            ],
            options={
