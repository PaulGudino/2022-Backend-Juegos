# Generated by Django 4.1.1 on 2022-10-17 23:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, editable=False, verbose_name='Fecha de creacion')),
                ('modified', models.DateTimeField(blank=True, editable=False, verbose_name='Fecha de modificacion')),
                ('state', models.CharField(choices=[('NO', 'Ninguno'), ('AC', 'Activo'), ('IN', 'Inactivo'), ('DI', 'Desabilitado')], default='N', max_length=2, verbose_name='Estado')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Fecha de modificacion')),
                ('state', models.CharField(choices=[('NO', 'Ninguno'), ('AC', 'Activo'), ('IN', 'Inactivo'), ('DI', 'Desabilitado')], default='N', max_length=2, verbose_name='Estado')),
                ('user_modify', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_client_modify', to=settings.AUTH_USER_MODEL, verbose_name='Usuario que modifica')),
                ('user_register', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_client_register', to=settings.AUTH_USER_MODEL, verbose_name='Usuario que registra')),
            ],
            options={
