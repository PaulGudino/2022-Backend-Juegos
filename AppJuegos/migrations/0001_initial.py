# Generated by Django 4.1.1 on 2022-12-02 19:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(max_length=100, verbose_name="Descripcion"),
                ),
                (
                    "imagen",
                    models.ImageField(upload_to="premios/", verbose_name="Imagen"),
                ),
                ("initial_stock", models.IntegerField(verbose_name="Stock inicial")),
                (
                    "condition_stock",
                    models.IntegerField(default=0, verbose_name="Stock Condicionado"),
                ),
                (
                    "prizes_awarded",
                    models.IntegerField(default=0, verbose_name="Premios entregados"),
                ),
                (
                    "created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modification_date",
                    models.DateTimeField(
                        null=True, verbose_name="Fecha  modificacion juego"
                    ),
                ),
                (
                    "game",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to="publicidad/", verbose_name="Imagen_publicidad"
                    ),
                ),
                (
                    "titulo",
                    models.CharField(max_length=100, verbose_name="titulo publicidad"),
                ),
                (
                    "created",
                    models.DateTimeField(
                ...
                (
                    "modified",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Fecha de modificacion"
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        null=True,
                        upload_to="design/",
                        verbose_name="imagen maquina tragamonedas",
                    ),
                ),
                (
                    ...
                    models.ImageField(
                        null=True,
                        upload_to="design/",
                        verbose_name="imagen fondo juego",
                    ),
                ),
                (
                    "image_logo_game",
                    models.ImageField(
                        null=True, upload_to="design/", verbose_name="imagen logo juego"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.FileField(
                        ...
                        verbose_name="video Salvapantallas",
                    ),
                ),
                (
                    "video_autoplay",
                    models.BooleanField(default=True, verbose_name="video autoplay"),
                ),
                (
                    "video_loop",
                    models.BooleanField(default=True, verbose_name="video loop"),
                ),
                (
                    ...
                    models.CharField(
                        max_length=100,
                        null=True,
                        verbose_name="titulo boton salvapantallas",
                    ),
                ),
                (
                    "scan_code_title",
                    models.CharField(default="Escanear Codigo", max_length=200),
                ),
                (
                    "scan_code_description",
                    models.CharField(
                        default="Puedes escanear el codigo QR de tu ticket",
                        max_length=200,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=150,
                        null=True,
                        verbose_name="titulo del ganador",
                    ),
                ),
                (
                    "description_winner",
                    models.CharField(
                        ...
                        max_length=200,
                        null=True,
                        verbose_name="descripcion ganador juego",
                    ),
                ),
                (
                    "image_winner",
                    models.FileField(
                        null=True, upload_to="design/", verbose_name="imagen ganador"
                    ),
                ),
                ("date_created", models.DateTimeField(auto_now_add=True)),
                ("date_modified", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "percent_win",
                    models.PositiveIntegerField(default=20, verbose_name="porcent_win"),
                ),
                (
                    "winners_limit",
                    models.PositiveIntegerField(
                        default=1, verbose_name="winners_limit"
                    ),
                ),
                (
                    "attempts_limit",
                    models.PositiveIntegerField(
                        default=1, verbose_name="numero de intentos"
                    ),
                ),
                (
                    "created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "win_match",
                    models.BooleanField(default=False, verbose_name="gano la partida?"),
                ),
                (
                    "state",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cedula",
                    models.CharField(
                        db_index=True, max_length=10, verbose_name="Cédula"
                    ),
                ),
                ("names", models.CharField(max_length=100, verbose_name="Nombres")),
                (
                ...
                (
                    "username",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="Nombre de usuario"
                    ),
                ),
                (
                    "email",
                    models.EmailField(
                        db_index=True, max_length=100, verbose_name="Correo Electronico"
                    ),
                ),
                (
                    "password",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image_background_game",
                    models.TextField(
                        max_length=100, null=True, verbose_name="imagen fondo juego"
                    ),
                ),
                (
                    "image_logo_game",
                    models.TextField(
                        max_length=100, null=True, verbose_name="imagen logo juego"
                    ),
                ),
                (
                    "color_background_game",
                ...
                (
                    "video_screensaver",
                    models.TextField(
                        max_length=100, null=True, verbose_name="video Salvapantallas"
                    ),
                ),
                (
                    "video_autoplay",
                ...
                (
                    "image_winner",
                    models.TextField(
                        max_length=100, null=True, verbose_name="imagen ganador"
                    ),
                ),
                ("date_created", models.DateTimeField(blank=True, editable=False)),
                ("date_modified", models.DateTimeField(blank=True, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.TextField(max_length=100, verbose_name="Imagen_publicidad"),
                ),
                (
                    "titulo",
                    models.CharField(max_length=100, verbose_name="titulo publicidad"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateTimeField(verbose_name="Fecha inicio premio"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="user_modify_award_condition",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="Usuario que modifica",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="user_register_award_condition",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="Usuario que registra",
                    ),
                ),
