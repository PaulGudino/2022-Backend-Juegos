# Generated by Django 4.1.1 on 2022-12-01 14:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ('image', models.ImageField(upload_to='publicidad/', verbose_name='Imagen_publicidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(blank=True, db_index=True)),
                ('image', models.TextField(max_length=100, verbose_name='Imagen_publicidad')),
                ('titulo', models.CharField(max_length=100, verbose_name='titulo publicidad')),
                ('created', models.DateTimeField(blank=True, editable=False, verbose_name='Fecha de creacion')),
                ('modified', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de modificacion')),
                ('is_active', models.BooleanField(default=True)),
